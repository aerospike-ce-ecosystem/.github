...
1-2. **aerospike-client-rust v2 추적** — [aerospike-client-rust v2](https://github.com/aerospike/aerospike-client-rust/tree/v2)를 Skills로 이해하고 있을 것. 최신 버전이 나오면 도입 검토할 것
